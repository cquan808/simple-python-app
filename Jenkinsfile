    ...
    stages {
        ...
        stage('Test') {
            ...
            steps {
                ...
                sh 'py.test --verbose --junit-xml test-reports/results.xml testMain.py'
            }
            post {
                always {
        ...
        stage('Deliver') {
                    ...
                    steps {
                        ...
                        dir(path: env.BUILD_ID) {
                            ...
                            //This bundles your main.py Python application into a single standalone executable file
